resource "openstack_compute_keypair_v2" "terraform" {
  name       = "${var.tag_namespace}_${var.tag_env}_tf"
...
resource "openstack_compute_secgroup_v2" "ssh_only" {
  # TODO, remove tag_cluster
  name        = "${var.tag_namespace}_${var.tag_env}_ssh_only"
...
/*
resource "openstack_compute_secgroup_v2" "all" {
  name        = "all"
  description = "Security group, allow all SSH ingress"
